...
/**
 * [XCarousel] allows moving back and forth through a set of child elements.
 *
 * It is based on a [similar component](http://twitter.github.com/bootstrap/javascript.html#carousel)
 * in Bootstrap.
 *
 * [XCarousel] leverages the [Swap] component to render the transition between items.
 */
class XCarousel extends WebComponent {
